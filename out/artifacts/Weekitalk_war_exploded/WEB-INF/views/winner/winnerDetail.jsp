	      ...
	      <div class="container">
		      <table id="table1">
				...
				<div class="button-group">
				  <a class="button is-info" href="${path1 }/winner/list.do">글 목록</a>
				  <a class="button is-primary" href="${path1 }/winner/delete.do?bno=${dto.bno}">글 삭제</a>
				  <a class="button is-danger" href="${path1 }/winner/edit.do?bno=${dto.bno}">글 수정</a>
				</div>
	      </div>
	    </div>
	</div>
