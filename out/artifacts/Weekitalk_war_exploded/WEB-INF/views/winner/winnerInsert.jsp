...
<div class="container is-fullhd">
	...
	<div class="content" id="contents">
	    <div class="row column text-center">
	      ...
	      <hr>
	      <div class="container">
	      	<form action="${path1 }/winner/insert.do" method="post">
			      <table id="table1">
			      	<tbody>
			      		<tr>
			      		...
			      		<tr>
			      			...
			      			<td>
			      				...
			      				<script>
			      				CKEDITOR.replace('content',	{filebrowserUploadUrl:'${path1}/winner/imageUpload.do'});
			      				</script>
			      			</td>
			      		</tr>
			      		<tr>
			      			<td colspan="2">
			      				...
			      				<a class="button is-primary" href="${path1 }/winner/list.do">글 목록</a>
			      			</td>
			      		</tr>
			      	</tbody>
			      </table>
