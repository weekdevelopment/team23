    ...
    <div class="content" id="content">
        <div class="row column text-center">
            <div class="container">
                ...
                <hr>
                <form action="${path0 }/admin/memberUpdate.do" method="post" onsubmit="return updateCheck(this)"> <!-- 컨트롤러 경로 수정 -->
                        ...
                        <table class="table_form">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <c:if test="${sid=='admin' }">
                                        <a href="${path0 }/admin/memberDelete.do?id=${member.id }" class="button is-primary">직권 강퇴</a>
                                    </c:if>
                                    <c:if test="${sid!='admin' }">
                                        <a href="${path0 }/admin/memberDelete.do?id=${sid }" class="button is-primary">회원 탈퇴</a>
                                    </c:if>
                                    <c:if test="${sid=='admin' }">
                                        <a href="${path0 }/admin/memberList.do" class="button is-primary">회원 목록</a>
                                    </c:if>
                                </td>
                            </tr>
                            </tbody>
